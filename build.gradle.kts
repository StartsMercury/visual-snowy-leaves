object Constants {
    ...
    const val VERSION_MINECRAFT = "25w19a"
}
...
dependencies {
    ...
    modImplementation(fabricApi.module("fabric-resource-loader-v0", "0.124.0+1.21.6"))

    modCompileOnly("com.terraformersmc:modmenu:14.0.0-rc.2")
    modRuntimeOnly(fabricApi.module("fabric-screen-api-v1", "0.124.0+1.21.6"))
    modRuntimeOnly(fabricApi.module("fabric-key-binding-api-v1", "0.124.0+1.21.6"))
    modRuntimeOnly(fabricApi.module("fabric-lifecycle-events-v1", "0.124.0+1.21.6"))
...
tasks.withType<ProcessResources> {
    val data = mapOf(
        ...
        "version_minecraft" to "1.21.6-alpha.25.19.a",
    )
