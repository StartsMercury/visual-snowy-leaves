object Constants {
    ...
    const val VERSION_MINECRAFT = "25w36a"
}
...
dependencies {
    ...
    modRuntimeOnly(fabricApi.module("fabric-lifecycle-events-v1", "0.133.4+1.21.9"))
    modRuntimeOnly(fabricApi.module("fabric-key-binding-api-v1", "0.133.4+1.21.9"))
    modRuntimeOnly(fabricApi.module("fabric-resource-loader-v0", "0.133.4+1.21.9"))
    modRuntimeOnly(fabricApi.module("fabric-screen-api-v1", "0.133.4+1.21.9"))
...
tasks.withType<ProcessResources> {
    val data = mapOf(
        ...
        "version_minecraft" to "1.21.9-alpha.25.36.a",
    )
