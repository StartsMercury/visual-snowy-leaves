...
dependencies {
    ...
    modImplementation(fabricApi.module("fabric-resource-loader-v0", "0.119.0+1.21.4"))

    modImplementation("com.terraformersmc:modmenu:13.0.3")
    modRuntimeOnly(fabricApi.module("fabric-screen-api-v1", "0.119.0+1.21.4"))
    modRuntimeOnly(fabricApi.module("fabric-key-binding-api-v1", "0.119.0+1.21.4"))
    modRuntimeOnly(fabricApi.module("fabric-lifecycle-events-v1", "0.119.0+1.21.4"))
