...
dependencies {
    ...
    modImplementation(fabricApi.module("fabric-resource-loader-v0", "0.115.3+1.21.5"))

    modImplementation("com.terraformersmc:modmenu:13.0.1")
    modRuntimeOnly(fabricApi.module("fabric-screen-api-v1", "0.115.3+1.21.5"))
    modRuntimeOnly(fabricApi.module("fabric-key-binding-api-v1", "0.115.3+1.21.5"))
    modRuntimeOnly(fabricApi.module("fabric-lifecycle-events-v1", "0.115.3+1.21.5"))
