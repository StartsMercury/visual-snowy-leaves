object Constants {
    ...
    const val VERSION_MINECRAFT = "1.21.5-rc2"
}
...
dependencies {
    ...
    modRuntimeOnly(fabricApi.module("fabric-screen-api-v1", "0.119.4+1.21.5"))
    modRuntimeOnly(fabricApi.module("fabric-key-binding-api-v1", "0.119.4+1.21.5"))
    modRuntimeOnly(fabricApi.module("fabric-lifecycle-events-v1", "0.119.4+1.21.5"))
...
tasks.withType<ProcessResources> {
    val data = mapOf(
        ...
        "version_minecraft" to "1.21.5-rc.2",
    )
