...
dependencies {
    ...
    modImplementation(fabricApi.module("fabric-resource-loader-v0", "0.119.9+1.21.5"))

    modImplementation("com.terraformersmc:modmenu:14.0.0-rc.2")
    modRuntimeOnly(fabricApi.module("fabric-screen-api-v1", "0.119.9+1.21.5"))
    modRuntimeOnly(fabricApi.module("fabric-key-binding-api-v1", "0.119.9+1.21.5"))
    modRuntimeOnly(fabricApi.module("fabric-lifecycle-events-v1", "0.119.9+1.21.5"))
