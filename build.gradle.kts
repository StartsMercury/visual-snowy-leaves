object Constants {
    ...
    const val VERSION_MINECRAFT = "1.21.7"
}
...
dependencies {
    ...
    modRuntimeOnly(fabricApi.module("fabric-lifecycle-events-v1", "0.129.0+1.21.7"))
    modRuntimeOnly(fabricApi.module("fabric-key-binding-api-v1", "0.129.0+1.21.7"))
    modRuntimeOnly(fabricApi.module("fabric-resource-loader-v0", "0.129.0+1.21.7"))
    modRuntimeOnly(fabricApi.module("fabric-screen-api-v1", "0.129.0+1.21.7"))
