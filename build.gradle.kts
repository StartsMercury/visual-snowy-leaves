object Constants {
    ...
    const val VERSION_MINECRAFT = "25w04a"
}
...
dependencies {
    ...
    modImplementation(fabricApi.module("fabric-resource-loader-v0", "0.115.1+1.21.5"))

    modImplementation("com.terraformersmc:modmenu:13.0.1")
    modRuntimeOnly(fabricApi.module("fabric-screen-api-v1", "0.115.1+1.21.5"))
    modRuntimeOnly(fabricApi.module("fabric-key-binding-api-v1", "0.115.1+1.21.5"))
    modRuntimeOnly(fabricApi.module("fabric-lifecycle-events-v1", "0.115.1+1.21.5"))
...
tasks.withType<ProcessResources> {
    val data = mapOf(
        ...
        "version_minecraft" to "1.21.5-alpha.25.4.a",
    )
