...
dependencies {
    ...
    modRuntimeOnly(fabricApi.module("fabric-lifecycle-events-v1", "0.136.0+1.21.10"))
    modRuntimeOnly(fabricApi.module("fabric-key-binding-api-v1", "0.136.0+1.21.10"))
    modRuntimeOnly(fabricApi.module("fabric-resource-loader-v0", "0.136.0+1.21.10"))
    modRuntimeOnly(fabricApi.module("fabric-screen-api-v1", "0.136.0+1.21.10"))
