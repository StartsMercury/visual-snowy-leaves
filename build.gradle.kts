object Constants {
    ...
    const val VERSION_MINECRAFT = "25w02a"
}
...
dependencies {
    ...
    modImplementation(fabricApi.module("fabric-resource-loader-v0", "0.114.1+1.21.5"))

    modImplementation("com.terraformersmc:modmenu:12.0.0-beta.1")
    modRuntimeOnly(fabricApi.module("fabric-screen-api-v1", "0.114.1+1.21.5"))
    modRuntimeOnly(fabricApi.module("fabric-key-binding-api-v1", "0.114.1+1.21.5"))
    modRuntimeOnly(fabricApi.module("fabric-lifecycle-events-v1", "0.114.1+1.21.5"))

    modCompileOnly("maven.modrinth:sodium:mc1.21.4-0.6.2-fabric")
}
...
tasks.withType<ProcessResources> {
    val data = mapOf(
        ...
        "version_minecraft" to "1.21.5-alpha.25.02.a",
    )
