...
dependencies {
    ...
    modRuntimeOnly(fabricApi.module("fabric-screen-api-v1", "0.118.2+1.21.5"))
    modRuntimeOnly(fabricApi.module("fabric-key-binding-api-v1", "0.118.2+1.21.5"))
    modRuntimeOnly(fabricApi.module("fabric-lifecycle-events-v1", "0.118.2+1.21.5"))
