...
/**
 * {@link EntityVertex#FORMAT} to {@link VslVertexFormats#TERRAIN} serializer.
 */
public class EntityToTerrainVertexSerializer implements VertexSerializer {
    ...
    public void serialize(long src, long dst, final int vertexCount) {
        for (var vertexIndex = 0; vertexIndex < vertexCount; vertexIndex++) {
            ...
            MemoryIntrinsics.copyMemory(src + 28, dst + 24, 8);
            // (data)=>32..36: VslIndex    1 x Int           = 1 x 4 =  4
            MemoryUtil.memPutInt(dst + 32, SodiumBlockFeatureContext.isSnowMarked() ? 1 : 0);
